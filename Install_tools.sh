...
sudo apt-get install -y xxd moreutils docker.io docker-compose mingw-w64 netexec seclists pipx bloodhound.py certipy-ad bloodyad hoaxshell neo4j feroxbuster enum4linux-ng coercer ghidra dnschef krb5-config krb5-user rlwrap kpcli
# Enable Docker
